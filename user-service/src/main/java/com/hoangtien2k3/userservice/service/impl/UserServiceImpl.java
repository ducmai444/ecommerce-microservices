package com.ducmai444.userservice.service.impl;

import com.google.gson.Gson;
import com.ducmai444.userservice.constant.KafkaConstant;
import com.ducmai444.userservice.event.EventProducer;
import com.ducmai444.userservice.exception.wrapper.*;
import com.ducmai444.userservice.model.dto.request.*;
import com.ducmai444.userservice.model.dto.response.InformationMessage;
import com.ducmai444.userservice.model.dto.response.JwtResponseMessage;
import com.ducmai444.userservice.model.entity.RoleName;
import com.ducmai444.userservice.model.entity.User;
import com.ducmai444.userservice.repository.UserRepository;
import com.ducmai444.userservice.security.jwt.JwtProvider;
import com.ducmai444.userservice.security.userprinciple.UserDetailService;
import com.ducmai444.userservice.security.userprinciple.UserPrinciple;
import com.ducmai444.userservice.service.RoleService;
import com.ducmai444.userservice.service.UserService;
...
public class UserServiceImpl implements UserService {
    ...
    private EmailDetails emailDetailsConfig(String username) {
        return EmailDetails.builder()
                .recipient("ducmai444dev@gmail.com")
    ...
    public String textSendEmailChangePasswordSuccessfully(String username) {
        return "Hey " + username + "!\n\n" +
                ...
                "Best regards:\n\n" +
                "Contact: ducmai4203@gmail.com\n" +
                "Fanpage: https://github.com/ducmai444";
    }
